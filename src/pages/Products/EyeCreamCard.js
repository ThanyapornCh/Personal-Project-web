import EyecreammPic from '../../assets/images/eyecream.png';
import React from 'react';

export default function EyeCreamCard({ name, discricptions, productPicture }) {
  return (
    <div className="w-[300px] h-[400px] flex flex-col items-center shadow-lg p-3 rounded-lg">
      <div class="w-60 h-80 p-5 rounded-xl  bg-white max-w-sm transform transition-all hover: -translate-y-2 duation-300">
        <img
          ...
          src={productPicture ?? EyecreammPic}
          alt="cleanser01"
        />
      </div>
      <div class="p-2">
