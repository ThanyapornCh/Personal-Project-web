    ...
    <form>
      <div className="w-full h-auto flex justify-center items-center flex-wrap px-10 gap-8">
        <div className="w-[300px] h-[400px] flex justify items-center">
          ...
          <div class="w-60 h-80 p-5 rounded-xl shadow-lg bg-white max-w-sm transform transition-all hover: -translate-y-2 duation-300 shadow-lg">
            <a href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light">
              <img
                class="h-40 w-full flex justify-center object-cover rounded-lg   "
                src={CleanserPic}
                alt="cleanser01"
              />
            </a>
