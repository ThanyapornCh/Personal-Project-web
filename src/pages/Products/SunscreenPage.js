...
export default function SunscreenPage() {
  return (
    <div className="w-full h-auto flex justify-center items-center flex-wrap px-10 gap-8">
      ...
      <div className="w-[300px] h-[400px] flex flex-col items-center shadow-lg p-3 rounded-lg">
        <div class="w-60 h-80 p-5 rounded-xl  bg-white max-w-sm transform transition-all hover: -translate-y-2 duation-300">
          <a href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light">
            <img
              className="h-40 w-40 flex justify-center object-cover rounded-lg   "
              src={SunscreenPic}
              alt="cleanser01"
            />
          </a>
        ...
        <div className="p-2">
          <h5 className="text-gray-900  text-lg font-medium mb-2">Eye Cream</h5>
      ...
      <div className="w-[300px] h-[400px] flex flex-col items-center shadow-lg p-3 rounded-lg">
        <div className="w-60 h-80 p-5 rounded-xl  bg-white max-w-sm transform transition-all hover: -translate-y-2 duation-300">
          <a href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light">
            <img
              className="h-40 w-40 flex justify-center object-cover rounded-lg   "
              src={SunscreenPic}
      ...
      <SunscreenCard
        name=" Eye Cream2"
        discricptions="Some quick example text to build on the card title and make up the bulk of the card's content."
        productPicture=""
      />
    </div>
  );
